...
StartupEvents.registry('mekanism:infuse_type', event => {
  event.createCustom('reclamation:sal_ammoniac', () => new $InfuseType($InfuseTypeBuilder.builder()
    .tint(0xBA31BA))
  )
  event.createCustom('reclamation:mercury', () => new $InfuseType($InfuseTypeBuilder.builder()
    .tint(0x919DB2))
  )
})
